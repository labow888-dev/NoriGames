...
const WORDS = {
  ...
  '🎉 เทศกาล': [
    ...
    'วันแม่','วันพ่อ','วันเด็ก','วันแรงงาน','วันครู',
    'Oktoberfest','Carnival','Diwali','Holi','Eid','Ramadan',
    'Thanksgiving','Hanukkah','Chinese New Year','Mid-Autumn Festival',
    'เทศกาลกินเจ','งานวัด','งานบวช','งานแต่ง','งานศพ','งานเลี้ยงรุ่น',
