...
const WORDS = {
  ...
  '🎉 เทศกาล': [
    'สงกรานต์','ลอยกระทง','ปีใหม่','ตรุษจีน','คริสต์มาส','ฮาโลวีน','วาเลนไทน์',
    'วันแม่','วันพ่อ','วันเด็ก','วันแรงงาน','วันครู','เทศกาลกินเจ','งานวัด','งานบวช','งานแต่ง','งานศพ','งานเลี้ยงรุ่น',
    'งานดนตรี','คอนเสิร์ต','งานแฟร์','งานเกม','งานอนิเมะ'
  ],
  '🏝️ จังหวัด': [
  ...
  '🎵 เครื่องดนตรี': [
    'กีตาร์','กีตาร์ไฟฟ้า','กีตาร์โปร่ง','เบส','กลอง','กลองชุด','กลองไฟฟ้า','กลองยาว',
    'เปียโน','คีย์บอร์ด','ซินธิไซเซอร์','ออร์แกน',
    'ไวโอลิน','วิโอลา','เชลโล','ดับเบิลเบส',
    'ขลุ่ย','ฟลุต','คลาริเน็ต','โอโบ','บาสซูน',
    'แซกโซโฟน','ทรัมเป็ต','ทรอมโบน','ทูบา','ฮอร์น',
    'พิณ','จะเข้','ระนาด','ระนาดเอก','ระนาดทุ้ม',
    'ฆ้อง','ฆ้องวง','ฉิ่ง','ฉาบ','กลองทัด',
    'อูคูเลเล่','แมนโดลิน','แบนโจ','ฮาร์ป','ลูท',
    'ดีเจคอนโทรลเลอร์','มิกเซอร์','แพดดรัม'
  ]
};
...
io.on('connection', socket => {
  ...
  /* สร้างห้อง */
  socket.on('createRoom', ({ name, avatar, maxPlayers, maxWrong, maxWinners, category }) => {
  ...
  /* ปรับ settings */
  socket.on('setSettings', ({ code, category, maxPlayers, maxWrong, maxWinners }) => {
    const room = rooms[code];
